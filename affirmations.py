...
# affirmations 
neutral_affirmation = ['Today will be a good day', 
                       'I am allowed to rest.', ]

happy_affirmation = ['I am filled with so much energy and joy.', 
                     'Expressing this joy is my right.', 
...
sad_affirmation = ['One bad moment doesn’t mean a bad day.', 
                   'This feeling will not last forever.']

angry_affirmation = ['There is nothing wrong with feeling angry.', 
                     'My anger does not always have to result in a strong reaction, but I am allowed to feel upset.', 
...
surprised_affirmation = ['How I express my emotions is my responsibility.', 
